...
export const MermaidDiagram: FC<MermaidDiagramProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <div
        onClick={handleClick}
        className="text-text-secondary bg-official-gray-800 absolute right-2 bottom-2 z-10 rounded px-2 py-1 text-xs"
      >
      ...
      <div
        ...
        onClick={handleClick}
        className={cn(
          'text-text-secondary bg-official-gray-850 focus:ring-opacity-50 relative w-full cursor-grab overflow-hidden rounded-b-lg p-4 py-10 text-center text-sm focus:cursor-grabbing focus:ring-2 focus:ring-blue-500 focus:outline-none',
          className,
        )}
