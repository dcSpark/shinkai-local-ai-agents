...
const MobileSettingsOverview = () => {
  ...
  return (
    <div className="bg-bg-default flex min-h-screen flex-col md:hidden">
                ...
                <div key={item.title}>
                  {item?.onClick ? (
                    <button
                      ...
                      className="hover:bg-bg-secondary flex w-full items-center justify-between px-4 py-4 transition-colors"
                    >
                    ...
                    <Link
                      to={item.href}
                      className="hover:bg-bg-secondary flex items-center justify-between px-4 py-4 transition-colors"
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex-shrink-0">{item.icon}</div>
                        <div className="flex flex-col items-start">
...
export default MobileSettingsOverview;
