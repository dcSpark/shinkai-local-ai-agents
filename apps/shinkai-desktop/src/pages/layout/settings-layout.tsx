...
export function MainNav() {
  ...
  return (
    <aside className="border-divider hidden max-w-[250px] flex-1 shrink-0 flex-col gap-4 overflow-x-hidden border-r px-2 py-6 pt-9 md:flex">
      {navigationSections.map((section) => (
        <div key={section.title} className="space-y-2">
          <h3 className="text-text-tertiary px-4 text-xs font-medium uppercase tracking-wider">
            {section.title}
          </h3>
